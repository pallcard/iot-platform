...
func (c *deviceClient) SendMessage(ctx context.Context, in *SendMessageReq, opts ...grpc.CallOption) (*SendMessageResp, error) {
...
func (UnimplementedDeviceServer) SendMessage(context.Context, *SendMessageReq) (*SendMessageResp, error) {
...
func _Device_SendMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeviceServer).SendMessage(ctx, req.(*SendMessageReq))
	}
